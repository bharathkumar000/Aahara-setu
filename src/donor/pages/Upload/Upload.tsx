...
export const Upload: React.FC = () => {
  ...
  const isFssaiRequired = ['Main Course', 'Bakery & Sweets', 'Fast Food'].includes(category);
          ...
          <Card className="upload-card">
            ...
            <form onSubmit={handleSubmit} className="upload-form">
              ...
              <div className="form-row">
                ...
                {isFssaiRequired && (
                  <div className={`fssai-verification-box animate-fade-in ${isActuallyVerified ? 'verified' : 'unverified'}`} style={{ gridColumn: 'span 2' }}>
                    <div className="fssai-box-header">
                       <ShieldAlert size={20} />
                       <h4>{isActuallyVerified ? 'Category Compliance Active' : 'FSSAI License Compulsory'}</h4>
                    </div>
                    <p className="fssai-box-desc">
                      {isActuallyVerified 
                        ? `Your verified license (#${fssaiId}) enables donations for ${category}.` 
                        : `To donate items in the ${category} category, a valid FSSAI ID is mandatory for safety compliance.`}
                    </p>
                    {!isActuallyVerified && (
                      <Button 
                        size="sm" 
